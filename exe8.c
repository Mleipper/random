/*program: xmas tree using gotoxy() and coloit */
...
int main(void)
{
	...
	SetConsoleTextAttribute(hConsole,FOREGROUND_INTENSITY|FOREGROUND_GREEN|FOREGROUND_RED|BACKGROUND_INTENSITY|BACKGROUND_RED|BACKGROUND_BLUE);
	...
	gotoxy(40,13);SetConsoleTextAttribute(hConsole,FOREGROUND_INTENSITY|FOREGROUND_GREEN); printf("x");
...
//moves cursor to x, y in console window
